...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		# By default selects 64bit libs for now
		SET(USE_WIN64 1)

		# Nvidia
		IF (DEFINED ENV{CUDA_INC_PATH})
			SET(OPENCL_INCLUDE_SEARCH_PATHS ${OPENCL_INCLUDE_SEARCH_PATHS} $ENV{CUDA_INC_PATH})
			IF (DEFINED USE_WIN64)
				SET(OPENCL_LIBRARY_SEARCH_PATHS ${OPENCL_LIBRARY_SEARCH_PATHS} $ENV{CUDA_LIB_PATH}/../lib64)
			ELSE()
		...
		IF (DEFINED ENV{INTELOCSDKROOT})
			...
			IF (DEFINED USE_WIN64)
				SET(OPENCL_LIBRARY_SEARCH_PATHS ${OPENCL_LIBRARY_SEARCH_PATHS} $ENV{INTELOCSDKROOT}/lib/x64)
			ELSE()
		...
		IF (DEFINED ENV{AMDAPPSDKROOT})
			...
			IF (DEFINED USE_WIN64)
				SET(OPENCL_LIBRARY_SEARCH_PATHS ${OPENCL_LIBRARY_SEARCH_PATHS} $ENV{AMDAPPSDKROOT}/lib/x86_64)
			ELSE()
		...
		FIND_LIBRARY(OPENCL_LIBRARIES OpenCL.lib HINTS ${OPENCL_LIBRARY_SEARCH_PATHS} PATHS ${OPENCL_LIB_DIR} ENV PATH)
